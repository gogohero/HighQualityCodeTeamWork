namespace Poker
{
    ...
    public partial class PokerGameForm : Form
    {
        ...
        public PokerGameForm()
        {
            ...
            this.textBoxChips.Text = "Chips : " + this.players[0].Chips.ToString();
            this.textBoxBotChips1.Text = "Chips : " + this.players[1].Chips.ToString();
            this.textBoxBotChips2.Text = "Chips : " + this.players[2].Chips.ToString();
            this.textBoxBotChips3.Text = "Chips : " + this.players[3].Chips.ToString();
            this.textBoxBotChips4.Text = "Chips : " + this.players[4].Chips.ToString();
            this.textBoxBotChips5.Text = "Chips : " + this.players[5].Chips.ToString();
